...
def PIDNet_S(num_classes, pretrain, pretrain_model_path):
...
def PIDNet_M(num_classes, pretrain, pretrain_model_path):
...
def PIDNet_L(num_classes, pretrain, pretrain_model_path):
